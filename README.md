...
Fork of [pay2text.xyz](https://pay2text.xyz) running on Tempo testnet (Moderato) instead of Base Sepolia. Same product, different chain — for side-by-side comparison.

- Base/CDP/x402 build: live at pay2text.xyz
- Tempo/MPP build: this repo, deploys to tempo.pay2text.xyz
